...
import {
  ...
  LogOut, User, ChevronDown, ChevronRight, Target, Menu, X
} from 'lucide-react';
    ...
    <>
      ...
      <div className="p-5 border-b border-slate-700 flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-slate-400 mt-0.5">Python Learning Platform</p>
        </div>
  ...
  return (
    <div className="flex h-screen bg-slate-900 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        {/* Mobile top bar */}
        <header className="md:hidden flex items-center gap-3 px-4 h-14 bg-slate-800 border-b border-slate-700 flex-shrink-0">
          <button
