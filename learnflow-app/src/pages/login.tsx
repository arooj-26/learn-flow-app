...
import { GraduationCap, Mail, Lock, Key, Loader2 } from 'lucide-react';
...
export default function LoginPage() {
  ...
  const handleSocialLogin = async (provider: 'google' | 'github') => {
    setError(`${provider.charAt(0).toUpperCase() + provider.slice(1)} sign-in is not configured. Please use email and password.`);
  };
